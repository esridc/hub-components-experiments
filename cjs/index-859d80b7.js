    ...
    ArcGISAuthError.prototype.retry = function (getSession, retryLimit) {
        ...
        var retryRequest = function (resolve, reject) {
            getSession(_this.url, _this.options)
                ...
                var newOptions = exports.__assign({}, _this.options, { authentication: session });
                tries = tries + 1;
...
function request(url, requestOptions) {
    ...
    var options = exports.__assign({ httpMethod: "POST" }, DEFAULT_ARCGIS_REQUEST_OPTIONS, requestOptions, {
        params: exports.__assign({}, DEFAULT_ARCGIS_REQUEST_OPTIONS.params, requestOptions.params),
        headers: exports.__assign({}, DEFAULT_ARCGIS_REQUEST_OPTIONS.headers, requestOptions.headers)
    });
    var missingGlobals = [];
    ...
    https://developers.arcgis.com/rest/users-groups-and-items/update-resources.htm
        ...
        fetchOptions.headers = exports.__assign({}, requestHeaders, options.headers);
...
function appendCustomParams(customOptions, keys, baseOptions) {
    ...
    var options = exports.__assign({ params: {} }, baseOptions, customOptions);
