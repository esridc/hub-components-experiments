...
const CalciteTip = class {
    ...
    renderHeader() {
        const { heading } = this;
        return heading ? (index.h("header", { class: CSS.header }, index.h("h3", { class: CSS.heading }, heading))) : null;
    }
    renderDismissButton() {
    ...
    render() {
        return (index.h(index.Host, null, index.h("article", { class: CSS.container, hidden: this.dismissed }, this.renderHeader(), this.renderContent()), this.renderDismissButton()));
    }
