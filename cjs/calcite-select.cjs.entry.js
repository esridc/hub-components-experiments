...
let CalciteSelect = class {
  ...
  render() {
    ...
    return (index.h(index.Fragment, null, index.h("select", { "aria-label": this.label, class: { [CSS.select]: true, [dom.CSS_UTILITY.rtl]: dir === "rtl" }, disabled: this.disabled, onChange: this.handleInternalSelectChange, ref: this.storeSelectRef }, index.h("slot", null)), this.renderChevron(dir), index.h(form.HiddenFormInputSlot, { component: this })));
  }
