...
const index$1 = require('./index-a2e82ee0.js');
...
let CalciteColorPicker = class {
  constructor(hostRef) {
    ...
    this.renderChannelsTab = (channelMode) => {
      ...
      return (index.h("calcite-tab", { active: active, class: resources.CSS.control, key: channelMode }, index.h("div", { class: resources.CSS.channels }, channels.map((channel, index) => this.renderChannel(channel, index, channelLabels[index], channelAriaLabels[index])))));
    };
    this.renderChannel = (value, index$1, label, ariaLabel) => (index.h("calcite-input", { class: resources.CSS.channel, "data-channel-index": index$1, label: ariaLabel, numberButtonType: "none", onCalciteInputChange: this.handleChannelChange, onCalciteInputInput: this.handleChannelInput, prefixText: label, scale: this.scale === "l" ? "m" : "s", type: "number", value: value === null || value === void 0 ? void 0 : value.toString() }));
    this.deleteColor = () => {
  ...
  render() {
    ...
    return (index.h("div", { class: resources.CSS.container }, index.h("div", { class: resources.CSS.colorFieldAndSliderWrap }, index.h("canvas", { class: {
      ...
      } }, intlHex), index.h("calcite-color-picker-hex-input", { allowEmpty: allowEmpty, class: resources.CSS.control, dir: elementDir, onCalciteColorPickerHexInputChange: this.handleHexInputChange, scale: hexInputScale, value: selectedColorInHex }))), hideChannels ? null : (index.h("calcite-tabs", { class: {
        [resources.CSS.colorModeContainer]: true,
        [resources.CSS.splitSection]: true
      }, dir: elementDir, scale: hexInputScale }, index.h("calcite-tab-nav", { slot: "tab-nav" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv"))))), hideSaved ? null : (index.h("div", { class: { [resources.CSS.savedColorsSection]: true, [resources.CSS.section]: true } }, index.h("div", { class: resources.CSS.header }, index.h("label", null, intlSaved), index.h("div", { class: resources.CSS.savedColorsButtons }, index.h("calcite-button", { appearance: "transparent", class: resources.CSS.deleteColor, color: "neutral", disabled: noColor, iconStart: "minus", label: intlDeleteColor, onClick: this.deleteColor, scale: hexInputScale }), index.h("calcite-button", { appearance: "transparent", class: resources.CSS.saveColor, color: "neutral", disabled: noColor, iconStart: "plus", label: intlSaveColor, onClick: this.saveColor, scale: hexInputScale }))), savedColors.length > 0 ? (index.h("div", { class: resources.CSS.savedColors }, [
