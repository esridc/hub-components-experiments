...
let CalciteAvatar = class {
  ...
  determineContent() {
    ...
    if (this.thumbnail && !this.error) {
      return (index.h("img", { alt: "", class: "thumbnail", dir: dir, onError: () => (this.error = true), src: this.thumbnail }));
    }
    const initials = this.generateInitials();
    const backgroundColor = this.generateFillColor();
    return (index.h("span", { class: "background", dir: dir, style: { backgroundColor } }, initials ? (index.h("span", { "aria-hidden": "true", class: "initials" }, initials)) : (index.h("calcite-icon", { class: "icon", icon: "user", scale: this.scale }))));
  }
  /**
