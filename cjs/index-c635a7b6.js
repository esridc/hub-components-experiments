...
function getPortalUrl(requestOptions) {
    ...
    if (requestOptions.portal) {
        return index$2.cleanUrl(requestOptions.portal);
    }
...
function updateItem(requestOptions) {
    return determineOwner(requestOptions).then(function (owner) {
        ...
        requestOptions.params = index$2.__assign({}, requestOptions.params, serializeItem(requestOptions.item));
...
function addItemPart(requestOptions) {
    return determineOwner(requestOptions).then(function (owner) {
        ...
        var options = index$2.appendCustomParams(requestOptions, ["file", "partNum"], { params: index$2.__assign({}, requestOptions.params) });
...
function createItemInFolder(requestOptions) {
    ...
    return determineOwner(requestOptions).then(function (owner) {
        ...
        requestOptions.params = index$2.__assign({}, requestOptions.params, serializeItem(requestOptions.item));
        // serialize the item into something Portal will accept
        var options = index$2.appendCustomParams(requestOptions, [
            "owner",
            "folderId",
            "file",
            "dataUrl",
...
function createItem(requestOptions) {
    ...
    var options = index$2.__assign({ folderId: null }, requestOptions);
...
function getItem(id, requestOptions) {
    ...
    var options = index$2.__assign({ httpMethod: "GET" }, requestOptions);
    return index$2.request(url, options);
}
/**
 * ```
...
function getItemData(id, requestOptions) {
    ...
    // default to a GET request
    var options = index$2.__assign({ httpMethod: "GET", params: {} }, requestOptions);
    if (options.file) {
        options.params.f = null;
    }
    return index$2.request(url, options).catch(function (err) {
...
function getItemStatus(requestOptions) {
    return determineOwner(requestOptions).then(function (owner) {
        ...
        var options = index$2.appendCustomParams(requestOptions, ["jobId", "jobType"], { params: index$2.__assign({}, requestOptions.params) });
        return index$2.request(url, options);
    });
}
...
var SearchQueryBuilder = /** @class */ (function () {
    ...
    SearchQueryBuilder.prototype.endGroup = function () {
        if (this.openGroups <= 0) {
            index$2.warn("`endGroup(...)` was called without calling `startGroup(...)` first. Your query was not modified.");
            return this;
        }
        this.commit();
        this.openGroups--;
    ...
    SearchQueryBuilder.prototype.addModifier = function (modifier) {
        ...
        if (this.q === "" && modifier !== "not") {
            index$2.warn("You have called `" + modifier + "()` without calling another method to modify your query first. Try calling `match()` first.");
            return this;
        }
    ...
    SearchQueryBuilder.prototype.cleanup = function () {
        ...
        if (oldQ !== this.q) {
            index$2.warn("`startGroup(...)` was called without calling `endGroup(...)` first. Your query was not modified.");
        }
        // clear empty groups
...
function genericSearch(search, searchType) {
    ...
    if (typeof search === "string" || search instanceof SearchQueryBuilder) {
        ...
        options = index$2.appendCustomParams(search, ["q", "num", "start", "sortField", "sortOrder"], {
            httpMethod: "GET"
        });
    }
    var path;
    ...
    // send the request
    return index$2.request(url, options).then(function (r) {
...
function getUser(requestOptions) {
    ...
    if (typeof requestOptions === "string") {
        ...
        options = index$2.__assign({}, requestOptions, options);
    }
    // send the request
    return index$2.request(url, options);
}
...
function updateUser(requestOptions) {
    ...
    requestOptions.params = index$2.__assign({}, requestOptions.user, requestOptions.params);
    delete requestOptions.user;
    // send the request
    return index$2.request(updateUrl, requestOptions);
}
//# sourceMappingURL=update.js.map
