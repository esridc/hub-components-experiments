...
const index$4 = require('./index-7258ef27.js');
...
function getEventServiceItem(orgId, requestOptions) {
    return index$3.searchItems(index$2.__assign({ q: "typekeywords:hubEventsLayer AND orgid:" + orgId }, requestOptions)).then(function (response) {
...
function queryFeatures(requestOptions) {
    var queryOptions = index$2.appendCustomParams(requestOptions, [
        "where",
        "objectIds",
        "relationParam",
        "time",
    ...
    return index$2.request(index$2.cleanUrl(requestOptions.url) + "/query", queryOptions);
}
...
function addFeatures(requestOptions) {
    ...
    var options = index$2.appendCustomParams(requestOptions, ["features", "gdbVersion", "returnEditMoment", "rollbackOnFailure"], { params: index$2.__assign({}, requestOptions.params) });
...
function searchEvents(requestOptions) {
    var queryOptions = index$2.__assign({ returnGeometry: true }, requestOptions);
...
function buildEventResponse(features, url, requestOptions, token) {
    ...
    return index$3.searchItems(searchRequestOptions).then(function (siteInfo) {
...
exports.getEventQueryFromType = getEventQueryFromType;
exports.getEventServiceUrl = getEventServiceUrl;
