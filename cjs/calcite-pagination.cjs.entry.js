...
let CalcitePagination = class {
  ...
  render() {
    ...
    return (index.h(index.Fragment, null, index.h("button", { "aria-label": this.textLabelPrevious, class: {
      ...
      }, disabled: prevDisabled, onClick: this.previousClicked }, index.h("calcite-icon", { dir: dir, flipRtl: true, icon: "chevronLeft", scale: "s" })), total > num ? this.renderPage(1) : null, this.renderLeftEllipsis(), this.renderPages(), this.renderRightEllipsis(), this.renderPage(this.getLastStart()), index.h("button", { "aria-label": this.textLabelNext, class: {
        [CSS.next]: true,
        [CSS.disabled]: nextDisabled
      }, disabled: nextDisabled, onClick: this.nextClicked }, index.h("calcite-icon", { dir: dir, flipRtl: true, icon: "chevronRight", scale: "s" }))));
  }
