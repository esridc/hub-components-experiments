...
var UserSession = /** @class */ (function () {
    ...
    UserSession.completeOAuth2 = function (options, win) {
        if (win === void 0) { win = window; }
        var _a = cleanUrl.__assign({ portal: "https://www.arcgis.com/sharing/rest", popup: true }, options), portal = _a.portal, clientId = _a.clientId, popup = _a.popup;
    ...
    UserSession.authorize = function (options, response) {
        ...
        var _a = cleanUrl.__assign({ portal: "https://arcgis.com/sharing/rest", expiration: 20160 }, options), portal = _a.portal, clientId = _a.clientId, expiration = _a.expiration, redirectUri = _a.redirectUri;
    ...
    UserSession.prototype.getUser = function (requestOptions) {
        ...
        if (this._pendingUserRequest) {
            ...
            var options = cleanUrl.__assign(cleanUrl.__assign({ httpMethod: "GET", authentication: this }, requestOptions), { rawResponse: false });
    ...
    UserSession.prototype.refreshWithUsernameAndPassword = function (requestOptions) {
        var _this = this;
        var options = cleanUrl.__assign({ params: {
                username: this.username,
                password: this.password,
