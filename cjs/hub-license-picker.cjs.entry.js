...
const HubLicensePicker = class {
    ...
    renderLicense(licenseId) {
        ...
        return (index.h("div", { class: "license-option" }, index.h("calcite-card", { selectable: true }, index.h("h3", { slot: "title" }, license.name), index.h("span", { slot: "subtitle" }, index.h("img", { slot: "", src: license.thumbnail }), " ", index.h("br", null), license.summary), index.h("calcite-link", { theme: "dark", slot: "footer-leading", href: license.url }, "More info"))));
    }
    render() {
