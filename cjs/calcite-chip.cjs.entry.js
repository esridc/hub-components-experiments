...
let CalciteChip = class {
  ...
  render() {
    ...
    const iconEl = (index.h("calcite-icon", { class: CSS.calciteChipIcon, dir: dir, flipRtl: this.iconFlipRtl, icon: this.icon, scale: "s" }));
