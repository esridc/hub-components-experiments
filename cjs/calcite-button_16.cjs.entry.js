...
const CalciteButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { dir: dir, hasText: this.hasText }, index.h(Tag, Object.assign({}, attributes, { disabled: this.disabled, onClick: this.handleClick, ref: (el) => (this.childEl = el), tabIndex: this.disabled ? -1 : null }), this.loading ? loader : null, this.iconStart ? iconStartEl : null, this.hasText ? contentEl : null, this.iconEnd ? iconEndEl : null)));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
...
const CalciteCard = class {
    ...
    render() {
        const dir = dom.getElementDir(this.el);
        return (index.h(index.Host, { dir: dir }, index.h("div", { class: "calcite-card-container" }, this.loading ? (index.h("div", { class: "calcite-card-loader-container" }, index.h("calcite-loader", { active: true, label: this.intlLoading }))) : null, index.h("section", { "aria-busy": this.loading.toString(), class: { [CSS$1.container]: true } }, this.selectable ? this.renderCheckbox() : null, this.renderThumbnail(), this.renderHeader(), index.h("div", { class: "card-content" }, index.h("slot", null)), this.renderFooter()))));
    }
    selectCard() {
    ...
    renderThumbnail() {
        ...
        return hasThumbnail ? (index.h("div", { class: CSS$1.thumbnailWrapper }, index.h("slot", { name: SLOTS.thumbnail }))) : null;
    }
    renderCheckbox() {
        const checkboxLabel = this.selected ? this.intlDeselect : this.intlSelect;
        return (index.h("label", { "aria-label": checkboxLabel, class: CSS$1.checkboxWrapper, onClick: this.cardSelectClick, onKeyDown: this.cardSelectKeyDown, title: checkboxLabel }, index.h("calcite-checkbox", { checked: this.selected, theme: this.theme })));
    }
    renderHeader() {
        const title = this.el.querySelector(`[slot=${SLOTS.title}]`);
        const subtitle = this.el.querySelector(`[slot=${SLOTS.subtitle}]`);
        const hasHeader = title || subtitle;
        return hasHeader ? (index.h("header", { class: CSS$1.header }, index.h("slot", { name: SLOTS.title }), index.h("slot", { name: SLOTS.subtitle }))) : null;
    }
    renderFooter() {
        ...
        return hasFooter ? (index.h("footer", { class: CSS$1.footer }, index.h("slot", { name: SLOTS.footerLeading }), index.h("slot", { name: SLOTS.footerTrailing }))) : null;
    }
    get el() { return index.getElement(this); }
};
