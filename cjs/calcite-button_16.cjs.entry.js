...
const search$1 = require('./search-453dd47b.js');
const get$1 = require('./get-1a802105.js');
...
let CalciteButton = class {
  ...
  render() {
    ...
    const loader = (index.h("div", { class: CSS$4.buttonLoader }, this.hasLoader ? (index.h("calcite-loader", { active: true, class: this.loading ? CSS$4.loadingIn : CSS$4.loadingOut, inline: true, label: this.intlLoading, scale: "m" })) : null));
    const iconStartEl = (index.h("calcite-icon", { class: { [CSS$4.icon]: true, [CSS$4.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: "s" }));
    const iconEndEl = (index.h("calcite-icon", { class: { [CSS$4.icon]: true, [CSS$4.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: "s" }));
    const contentEl = (index.h("span", { class: CSS$4.content }, index.h("slot", null)));
    return (index.h(Tag, { "aria-label": label.getLabelText(this), class: { [dom.CSS_UTILITY.rtl]: dir === "rtl", [CSS$4.contentSlotted]: this.hasContent }, disabled: this.disabled || this.loading, href: this.childElType === "a" && this.href, name: this.childElType === "button" && this.name, onClick: this.handleClick, ref: (el) => (this.childEl = el), rel: this.childElType === "a" && this.rel, tabIndex: this.disabled || this.loading ? -1 : null, target: this.childElType === "a" && this.target, type: this.childElType === "button" && this.type }, loader, this.iconStart ? iconStartEl : null, this.hasContent ? contentEl : null, this.iconEnd ? iconEndEl : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
let CalciteCard = class {
  ...
  render() {
    const dir = dom.getElementDir(this.el);
    return (index.h("div", { class: { "calcite-card-container": true, [dom.CSS_UTILITY.rtl]: dir === "rtl" } }, this.loading ? (index.h("div", { class: "calcite-card-loader-container" }, index.h("calcite-loader", { active: true, label: this.intlLoading }))) : null, index.h("section", { "aria-busy": this.loading.toString(), class: { [CSS$3.container]: true } }, this.selectable ? this.renderCheckbox() : null, this.renderThumbnail(), this.renderHeader(), index.h("div", { class: "card-content" }, index.h("slot", null)), this.renderFooter())));
  }
  selectCard() {
  ...
  renderThumbnail() {
    ...
    return hasThumbnail ? (index.h("div", { class: CSS$3.thumbnailWrapper }, index.h("slot", { name: SLOTS$1.thumbnail }))) : null;
  }
  renderCheckbox() {
    const checkboxLabel = this.selected ? this.intlDeselect : this.intlSelect;
    return (index.h("calcite-label", { class: CSS$3.checkboxWrapper, onClick: this.cardSelectClick, onKeyDown: this.cardSelectKeyDown }, index.h("calcite-checkbox", { checked: this.selected, label: checkboxLabel })));
  }
  renderHeader() {
    const title = this.el.querySelector(`[slot=${SLOTS$1.title}]`);
    const subtitle = this.el.querySelector(`[slot=${SLOTS$1.subtitle}]`);
    const hasHeader = title || subtitle;
    return hasHeader ? (index.h("header", { class: CSS$3.header }, index.h("slot", { name: SLOTS$1.title }), index.h("slot", { name: SLOTS$1.subtitle }))) : null;
  }
  renderFooter() {
    ...
    return hasFooter ? (index.h("footer", { class: CSS$3.footer }, index.h("slot", { name: SLOTS$1.footerLeading }), index.h("slot", { name: SLOTS$1.footerTrailing }))) : null;
  }
  get el() { return index.getElement(this); }
};
...
let CalciteCheckbox = class {
  ...
  // --------------------------------------------------------------------------
  render() {
    return (index.h(index.Host, { onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, index.h("div", { "aria-checked": this.checked.toString(), "aria-label": label.getLabelText(this), class: "toggle", onBlur: this.onToggleBlur, onFocus: this.onToggleFocus, ref: (toggleEl) => (this.toggleEl = toggleEl), role: "checkbox", tabIndex: 0 }, index.h("svg", { class: "check-svg", viewBox: "0 0 16 16" }, index.h("path", { d: this.getPath() })), index.h("slot", null)), index.h(form.HiddenFormInputSlot, { component: this })));
  }
  get el() { return index.getElement(this); }
};
...
let CalciteLabel = class {
  ...
  render() {
    const dir = dom.getElementDir(this.el);
    return (index.h(index.Host, { onClick: this.labelClickHandler }, index.h("div", { class: { [CSS$1.container]: true, [dom.CSS_UTILITY.rtl]: dir === "rtl" } }, index.h("slot", null))));
  }
  get el() { return index.getElement(this); }
};
...
let CalciteTreeItem = class {
  ...
  render() {
    ...
    const checkbox = this.selectionMode === TreeSelectionMode.Ancestors ? (index.h("label", { class: CSS.checkboxLabel }, index.h("calcite-checkbox", { checked: this.selected, class: CSS.checkbox, "data-test-id": "checkbox", indeterminate: this.hasChildren && this.indeterminate, scale: this.scale, tabIndex: -1 }), index.h("slot", null))) : null;
    ...
    return (index.h(index.Host, { "aria-expanded": this.hasChildren ? this.expanded.toString() : undefined, "aria-hidden": hidden.toString(), "aria-selected": this.selected ? "true" : showCheckmark ? "false" : undefined, "calcite-hydrated-hidden": hidden, role: "treeitem", tabindex: this.parentExpanded || this.depth === 1 ? "0" : "-1" }, index.h("div", { class: {
        ...
        [dom.CSS_UTILITY.rtl]: rtl
      }, "data-selection-mode": this.selectionMode, ref: (el) => (this.defaultSlotWrapper = el) }, chevron, bulletOrCheckIcon, checkbox ? checkbox : index.h("slot", null)), index.h("div", { class: {
...
let HubFilterCategory = class {
  ...
  renderTree() {
    ...
    output.push(index.h("calcite-tree", { "selection-mode": "multi-children" }, root));
    return output;
  }
  render() {
...
let HubGallery = class {
  ...
  async updateGallery(query, customParams) {
    let auth = (this.session !== undefined && this.session !== null) ? UserSession.UserSession.deserialize(this.session) : null;
...
function geocode(address) {
    ...
    if (typeof address === "string") {
        ...
        options = getPortalUrl.appendCustomParams(address, [
            "singleLine",
            "address",
            "address2",
            "address3",
    ...
    return cleanUrl.request(cleanUrl.cleanUrl(endpoint) + "/findAddressCandidates", options).then(function (response) {
...
function suggest(partialText, requestOptions) {
    var options = cleanUrl.__assign({ endpoint: ARCGIS_ONLINE_GEOCODING_URL, params: {} }, requestOptions);
    options.params.text = partialText;
    return cleanUrl.request(cleanUrl.cleanUrl(options.endpoint) + "/suggest", options);
}
...
function getMap(id) {
  return new Promise((resolve, reject) => {
    Promise.all([get$1.getItem(id), get$1.getItemData(id)])
      .then(resolve)
      .catch(reject);
  });
}
...
function getFeatures(layer, location) {
  ...
  // }
  return new Promise((resolve, reject) => {
    search$1.queryFeatures(options)
      .then(results => {
      let collection = {
        "title": layer.title,
...
let HubRadar = class {
  ...
  render() {
    ...
    if (this.isLoading) {
      output.push(index.h("calcite-loader", { label: "label", text: "Scanning radar...", "is-active": true }));
    }
    else {
      // Get Results
