import { searchUsers, getUser, searchGroups, updateUser } from "@esri/arcgis-rest-portal";
...
import { searchAnnotations, getAnnotationServiceUrl } from "@esri/hub-annotations";
...
export function getMemberOrg(_username) {
  return {
    id: "BBpPn9wZu2D6eTNY",
...
export async function searchMembers(query, authentication) {
...
export async function updateMember(id, attributes, authentication) {
...
export async function getMemberEvents(authentication) {
  // Process:
...
export async function setMemberPlaces(username, places, authentication) {
...
export async function getMemberPlaces(username, authentication) {
  let places;
  try {
...
export async function getMemberTeams(authentication) {
...
export async function searchMemberComments(username, authentication) {
  let query = ["1=1"];
...
export async function searchMemberContent(username, authentication) {
...
export function convertUserToMember(user, _authentication) {
