import { HubType, ControlOptions } from "./hub-types";
 ...
 * @export
 */
export function getContent(id, hubRequestOptions) {
...
export async function updateContent(id, attributes, authentication) {
  // Portal
  updateItem({
 ...
 * @export
 */
export function _getContentFromPortal(id, hubRequestOptions) {
 ...
 * @export
 */
export function _convertItemToContent(item) {
 ...
 * @export
 */
export function _getContentFromHub(id, hubRequestOptions) {
 ...
 * @export
 */
export function _convertHubv3ToContent(hubmodel) {
...
export function getFromHubAPI(id, hubRequestOptions) {
