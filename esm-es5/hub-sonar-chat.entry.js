...
var hubSonarChatCss = ":host{display:block}";
var HubSonarChat = /** @class */ (function () {
    ...
    class_1.prototype.onChatSubmittedHandler = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            var messages, path, url, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.debug("HubSonarChat: onChatSubmitted", event);
                        messages = undefined;
                        if (!this.service) return [3 /*break*/, 3];
                        path = event.detail.route ? event.detail.route : '/index';
