...
var CalciteBlock = /** @class */ (function () {
    ...
    //
    // --------------------------------------------------------------------------
    CalciteBlock.prototype.renderScrim = function () {
        var _a = this, disabled = _a.disabled, loading = _a.loading, el = _a.el;
    ...
    CalciteBlock.prototype.render = function () {
        var _a;
        var _b = this, collapsible = _b.collapsible, disabled = _b.disabled, el = _b.el, heading = _b.heading, intlCollapse = _b.intlCollapse, intlExpand = _b.intlExpand, loading = _b.loading, open = _b.open, summary = _b.summary, intlLoading = _b.intlLoading;
        var toggleLabel = open ? intlCollapse || TEXT.collapse : intlExpand || TEXT.expand;
        var hasIcon = getSlotted(el, SLOTS.icon);
        var headerContent = (h("header", { class: CSS.header }, hasIcon ? (h("div", { class: CSS.icon }, h("slot", { name: SLOTS.icon }))) : null, h("div", { class: CSS.title }, h("h4", { class: CSS.heading }, heading), summary ? h("div", { class: CSS.summary }, summary) : null)));
        var hasControl = getSlotted(el, SLOTS.control);
        ...
        return (h(Host, { tabIndex: disabled ? -1 : null }, h("article", { "aria-busy": loading.toString(), "aria-expanded": collapsible ? open.toString() : null, class: (_a = {},
                _a[CSS.article] = true,
                _a[CSS_UTILITY.rtl] = rtl,
                _a) }, headerNode, h("div", { class: CSS.content, hidden: !open }, this.renderScrim()))));
    };
