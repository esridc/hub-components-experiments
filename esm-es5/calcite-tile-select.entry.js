...
var CalciteTileSelect = /** @class */ (function () {
    ...
    CalciteTileSelect.prototype.checkedChanged = function (newChecked) {
        this.input.checked = newChecked;
    };
    CalciteTileSelect.prototype.nameChanged = function (newName) {
    ...
    //
    //--------------------------------------------------------------------------
    CalciteTileSelect.prototype.calciteCheckboxChangeEvent = function (event) {
        var checkbox = event.target;
        if (checkbox === this.input) {
            this.checked = checkbox.checked;
        }
    };
    CalciteTileSelect.prototype.calciteCheckboxFocusedChangeEvent = function (event) {
        var checkbox = event.target;
        if (checkbox === this.input) {
            this.focused = checkbox.focused;
        }
    };
    CalciteTileSelect.prototype.calciteRadioButtonCheckedChangeEvent = function (event) {
    ...
    CalciteTileSelect.prototype.calciteRadioButtonFocusedChangeEvent = function (event) {
        var radioButton = event.target;
        if (radioButton === this.input) {
            this.focused = radioButton.focused;
        }
    };
    CalciteTileSelect.prototype.click = function (event) {
        var target = event.target;
        var targets = ["calcite-tile", "calcite-tile-select"];
        if (targets.includes(target.localName)) {
            this.input.click();
        }
    };
    CalciteTileSelect.prototype.mouseenter = function () {
    ...
    CalciteTileSelect.prototype.mouseleave = function () {
        if (this.input.localName === "calcite-radio-button") {
    ...
    //
    //--------------------------------------------------------------------------
    CalciteTileSelect.prototype.connectedCallback = function () {
        this.renderInput();
    };
    CalciteTileSelect.prototype.disconnectedCallback = function () {
    ...
    //
    // --------------------------------------------------------------------------
    CalciteTileSelect.prototype.renderInput = function () {
    ...
    CalciteTileSelect.prototype.render = function () {
    ...
    Object.defineProperty(CalciteTileSelect.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CalciteTileSelect, "watchers", {
        get: function () {
            return {
