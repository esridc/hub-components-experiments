...
var CalciteShellPanel = /** @class */ (function () {
    ...
    CalciteShellPanel.prototype.watchHandler = function () {
    ...
    //
    // --------------------------------------------------------------------------
    CalciteShellPanel.prototype.render = function () {
        var _a;
        var _b = this, collapsed = _b.collapsed, detached = _b.detached, position = _b.position;
        var contentNode = (h("div", { class: (_a = {}, _a[CSS.content] = true, _a[CSS.contentDetached] = detached, _a), hidden: collapsed }, h("slot", null)));
        var actionBarNode = h("slot", { name: SLOTS.actionBar });
    ...
    Object.defineProperty(CalciteShellPanel, "watchers", {
        get: function () {
            return {
