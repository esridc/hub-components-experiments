...
var CalciteAccordionItem = /** @class */ (function () {
    ...
    //
    //--------------------------------------------------------------------------
    CalciteAccordionItem.prototype.connectedCallback = function () {
...
var CalciteInputMessage = /** @class */ (function () {
    ...
    CalciteInputMessage.prototype.handleIconEl = function () {
    ...
    //
    //--------------------------------------------------------------------------
    CalciteInputMessage.prototype.renderIcon = function (iconName) {
        if (iconName) {
    ...
    Object.defineProperty(CalciteInputMessage, "watchers", {
        get: function () {
            return {
                "status": ["handleIconEl"],
                "icon": ["handleIconEl"]
    ...
    class_2.prototype.getMetadataValue = function (attr) {
        ...
        if (!!this.resource) {
            ...
            if (!!this.inputs[attr].translation[this.translator]) {
                value = this.inputs[attr].translation[this.translator][0].split('.').reduce(function (o, i) { return o[i]; }, this.resource);
            }
            else {
