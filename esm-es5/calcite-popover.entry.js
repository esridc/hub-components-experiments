...
var CalcitePopover = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.setExpandedAttr = function () {
            var _c = _this, _referenceElement = _c._referenceElement, open = _c.open;
    ...
    class_1.prototype.createPopper = function () {
        this.destroyPopper();
        var _c = this, el = _c.el, placement = _c.placement, referenceEl = _c._referenceElement;
    ...
    class_1.prototype.renderCloseButton = function () {
        var _c;
        var _this = this;
        var _d = this, closeButton = _d.closeButton, intlClose = _d.intlClose;
        return closeButton ? (h("button", { "aria-label": intlClose, class: (_c = {}, _c[CSS.closeButton] = true, _c), onClick: this.hide, ref: function (closeButtonEl) { return (_this.closeButtonEl = closeButtonEl); }, title: intlClose }, h("calcite-icon", { icon: "x", scale: "m" }))) : null;
    };
    class_1.prototype.render = function () {
        var _c;
        var _this = this;
        var _d = this, _referenceElement = _d._referenceElement, label = _d.label, open = _d.open, disablePointer = _d.disablePointer;
        ...
        return (h(Host, { "aria-hidden": hidden.toString(), "aria-label": label, "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, h("div", { class: (_c = {},
                _c[CSS$1.animation] = true,
                _c[CSS$1.animationActive] = displayed,
                _c) }, arrowNode, h("div", { class: CSS.container }, this.renderImage(), h("div", { class: CSS.content }, h("slot", null), this.renderCloseButton())))));
    };
