...
var CalciteSlider = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        var handle = (h("button", { "aria-label": this.isRange ? this.maxLabel : this.minLabel, "aria-orientation": "horizontal", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": value, class: {
                thumb: true,
                "thumb--value": true,
                "thumb--active": this.lastDragProp !== "minMaxValue" && this.dragProp === maxProp
            }, disabled: this.disabled, onBlur: function () { return (_this.activeProp = null); }, onFocus: function () { return (_this.activeProp = maxProp); }, onMouseDown: function () { return _this.dragStart(maxProp); }, onTouchStart: function (e) { return _this.dragStart(maxProp, e); }, ref: function (el) { return (_this.maxHandle = el); }, role: "slider", style: { right: right } }, h("div", { class: "handle" })));
        var labeledHandle = (h("button", { "aria-label": this.isRange ? this.maxLabel : this.minLabel, "aria-orientation": "horizontal", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": value, class: {
                thumb: true,
                "thumb--value": true,
                "thumb--active": this.lastDragProp !== "minMaxValue" && this.dragProp === maxProp
            }, disabled: this.disabled, onBlur: function () { return (_this.activeProp = null); }, onFocus: function () { return (_this.activeProp = maxProp); }, onMouseDown: function () { return _this.dragStart(maxProp); }, onTouchStart: function (e) { return _this.dragStart(maxProp, e); }, ref: function (el) { return (_this.maxHandle = el); }, role: "slider", style: { right: right } }, h("span", { "aria-hidden": "true", class: "handle__label handle__label--value" }, value ? value.toLocaleString() : value), h("span", { "aria-hidden": "true", class: "handle__label handle__label--value static" }, value ? value.toLocaleString() : value), h("span", { "aria-hidden": "true", class: "handle__label handle__label--value transformed" }, value ? value.toLocaleString() : value), h("div", { class: "handle" })));
        var histogramLabeledHandle = (h("button", { "aria-label": this.isRange ? this.maxLabel : this.minLabel, "aria-orientation": "horizontal", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": value, class: {
                thumb: true,
                "thumb--value": true,
                "thumb--active": this.lastDragProp !== "minMaxValue" && this.dragProp === maxProp
            }, disabled: this.disabled, onBlur: function () { return (_this.activeProp = null); }, onFocus: function () { return (_this.activeProp = maxProp); }, onMouseDown: function () { return _this.dragStart(maxProp); }, onTouchStart: function (e) { return _this.dragStart(maxProp, e); }, ref: function (el) { return (_this.maxHandle = el); }, role: "slider", style: { right: right } }, h("div", { class: "handle" }), h("span", { "aria-hidden": "true", class: "handle__label handle__label--value" }, value ? value.toLocaleString() : value), h("span", { "aria-hidden": "true", class: "handle__label handle__label--value static" }, value ? value.toLocaleString() : value), h("span", { "aria-hidden": "true", class: "handle__label handle__label--value transformed" }, value ? value.toLocaleString() : value)));
        var preciseHandle = (h("button", { "aria-label": this.isRange ? this.maxLabel : this.minLabel, "aria-orientation": "horizontal", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": value, class: {
                thumb: true,
                "thumb--value": true,
                "thumb--active": this.lastDragProp !== "minMaxValue" && this.dragProp === maxProp,
                "thumb--precise": true
            }, disabled: this.disabled, onBlur: function () { return (_this.activeProp = null); }, onFocus: function () { return (_this.activeProp = maxProp); }, onMouseDown: function () { return _this.dragStart(maxProp); }, onTouchStart: function (e) { return _this.dragStart(maxProp, e); }, ref: function (el) { return (_this.maxHandle = el); }, role: "slider", style: { right: right } }, h("div", { class: "handle" }), h("div", { class: "handle-extension" })));
        var histogramPreciseHandle = (h("button", { "aria-label": this.isRange ? this.maxLabel : this.minLabel, "aria-orientation": "horizontal", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": value, class: {
                thumb: true,
                "thumb--value": true,
                "thumb--active": this.lastDragProp !== "minMaxValue" && this.dragProp === maxProp,
                "thumb--precise": true
            }, disabled: this.disabled, onBlur: function () { return (_this.activeProp = null); }, onFocus: function () { return (_this.activeProp = maxProp); }, onMouseDown: function () { return _this.dragStart(maxProp); }, onTouchStart: function (e) { return _this.dragStart(maxProp, e); }, ref: function (el) { return (_this.maxHandle = el); }, role: "slider", style: { right: right } }, h("div", { class: "handle-extension" }), h("div", { class: "handle" })));
        var labeledPreciseHandle = (h("button", { "aria-label": this.isRange ? this.maxLabel : this.minLabel, "aria-orientation": "horizontal", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": value, class: {
                thumb: true,
                "thumb--value": true,
                "thumb--active": this.lastDragProp !== "minMaxValue" && this.dragProp === maxProp,
                "thumb--precise": true
            }, disabled: this.disabled, onBlur: function () { return (_this.activeProp = null); }, onFocus: function () { return (_this.activeProp = maxProp); }, onMouseDown: function () { return _this.dragStart(maxProp); }, onTouchStart: function (e) { return _this.dragStart(maxProp, e); }, ref: function (el) { return (_this.maxHandle = el); }, role: "slider", style: { right: right } }, h("span", { "aria-hidden": "true", class: "handle__label handle__label--value" }, value ? value.toLocaleString() : value), h("span", { "aria-hidden": "true", class: "handle__label handle__label--value static" }, value ? value.toLocaleString() : value), h("span", { "aria-hidden": "true", class: "handle__label handle__label--value transformed" }, value ? value.toLocaleString() : value), h("div", { class: "handle" }), h("div", { class: "handle-extension" })));
        var histogramLabeledPreciseHandle = (h("button", { "aria-label": this.isRange ? this.maxLabel : this.minLabel, "aria-orientation": "horizontal", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": value, class: {
                thumb: true,
                "thumb--value": true,
                "thumb--active": this.lastDragProp !== "minMaxValue" && this.dragProp === maxProp,
                "thumb--precise": true
            }, disabled: this.disabled, onBlur: function () { return (_this.activeProp = null); }, onFocus: function () { return (_this.activeProp = maxProp); }, onMouseDown: function () { return _this.dragStart(maxProp); }, onTouchStart: function (e) { return _this.dragStart(maxProp, e); }, ref: function (el) { return (_this.maxHandle = el); }, role: "slider", style: { right: right } }, h("div", { class: "handle-extension" }), h("div", { class: "handle" }), h("span", { "aria-hidden": "true", class: "handle__label handle__label--value" }, value ? value.toLocaleString() : value), h("span", { "aria-hidden": "true", class: "handle__label handle__label--value static" }, value ? value.toLocaleString() : value), h("span", { "aria-hidden": "true", class: "handle__label handle__label--value transformed" }, value ? value.toLocaleString() : value)));
        var minHandle = (h("button", { "aria-label": this.minLabel, "aria-orientation": "horizontal", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": this.minValue, class: {
                thumb: true,
                "thumb--minValue": true,
                "thumb--active": this.dragProp === "minValue"
            }, disabled: this.disabled, onBlur: function () { return (_this.activeProp = null); }, onFocus: function () { return (_this.activeProp = "minValue"); }, onMouseDown: function () { return _this.dragStart("minValue"); }, onTouchStart: function (e) { return _this.dragStart("minValue", e); }, ref: function (el) { return (_this.minHandle = el); }, role: "slider", style: { left: left } }, h("div", { class: "handle" })));
        var minLabeledHandle = (h("button", { "aria-label": this.minLabel, "aria-orientation": "horizontal", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": this.minValue, class: {
                thumb: true,
                "thumb--minValue": true,
                "thumb--active": this.dragProp === "minValue"
            }, disabled: this.disabled, onBlur: function () { return (_this.activeProp = null); }, onFocus: function () { return (_this.activeProp = "minValue"); }, onMouseDown: function () { return _this.dragStart("minValue"); }, onTouchStart: function (e) { return _this.dragStart("minValue", e); }, ref: function (el) { return (_this.minHandle = el); }, role: "slider", style: { left: left } }, h("span", { "aria-hidden": "true", class: "handle__label handle__label--minValue" }, this.minValue && this.minValue.toLocaleString()), h("span", { "aria-hidden": "true", class: "handle__label handle__label--minValue static" }, this.minValue && this.minValue.toLocaleString()), h("span", { "aria-hidden": "true", class: "handle__label handle__label--minValue transformed" }, this.minValue && this.minValue.toLocaleString()), h("div", { class: "handle" })));
        var minHistogramLabeledHandle = (h("button", { "aria-label": this.minLabel, "aria-orientation": "horizontal", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": this.minValue, class: {
                thumb: true,
                "thumb--minValue": true,
                "thumb--active": this.dragProp === "minValue"
            }, disabled: this.disabled, onBlur: function () { return (_this.activeProp = null); }, onFocus: function () { return (_this.activeProp = "minValue"); }, onMouseDown: function () { return _this.dragStart("minValue"); }, onTouchStart: function (e) { return _this.dragStart("minValue", e); }, ref: function (el) { return (_this.minHandle = el); }, role: "slider", style: { left: left } }, h("div", { class: "handle" }), h("span", { "aria-hidden": "true", class: "handle__label handle__label--minValue" }, this.minValue && this.minValue.toLocaleString()), h("span", { "aria-hidden": "true", class: "handle__label handle__label--minValue static" }, this.minValue && this.minValue.toLocaleString()), h("span", { "aria-hidden": "true", class: "handle__label handle__label--minValue transformed" }, this.minValue && this.minValue.toLocaleString())));
        var minPreciseHandle = (h("button", { "aria-label": this.minLabel, "aria-orientation": "horizontal", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": this.minValue, class: {
                thumb: true,
                "thumb--minValue": true,
                "thumb--active": this.dragProp === "minValue",
                "thumb--precise": true
            }, disabled: this.disabled, onBlur: function () { return (_this.activeProp = null); }, onFocus: function () { return (_this.activeProp = "minValue"); }, onMouseDown: function () { return _this.dragStart("minValue"); }, onTouchStart: function (e) { return _this.dragStart("minValue", e); }, ref: function (el) { return (_this.minHandle = el); }, role: "slider", style: { left: left } }, h("div", { class: "handle-extension" }), h("div", { class: "handle" })));
        var minLabeledPreciseHandle = (h("button", { "aria-label": this.minLabel, "aria-orientation": "horizontal", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": this.minValue, class: {
                thumb: true,
                "thumb--minValue": true,
                "thumb--active": this.dragProp === "minValue",
                "thumb--precise": true
            }, disabled: this.disabled, onBlur: function () { return (_this.activeProp = null); }, onFocus: function () { return (_this.activeProp = "minValue"); }, onMouseDown: function () { return _this.dragStart("minValue"); }, onTouchStart: function (e) { return _this.dragStart("minValue", e); }, ref: function (el) { return (_this.minHandle = el); }, role: "slider", style: { left: left } }, h("div", { class: "handle-extension" }), h("div", { class: "handle" }), h("span", { "aria-hidden": "true", class: "handle__label handle__label--minValue" }, this.minValue && this.minValue.toLocaleString()), h("span", { "aria-hidden": "true", class: "handle__label handle__label--minValue static" }, this.minValue && this.minValue.toLocaleString()), h("span", { "aria-hidden": "true", class: "handle__label handle__label--minValue transformed" }, this.minValue && this.minValue.toLocaleString())));
    ...
    class_1.prototype.hyphenateCollidingRangeHandleLabels = function () {
        ...
        if (labelTransformedOverlap > 0) {
            ...
            if (valueLabelStaticHostOffset === 0 && minValueLabelStaticHostOffset === 0) {
                ...
                var valueLabelTransformedHostOffset = this.getHostOffset(valueLabelTransformed.getBoundingClientRect().left + valueLabelTranslate, valueLabelTransformed.getBoundingClientRect().right + valueLabelTranslate);
                ...
                var minValueLabelTranslate = Math.abs(minValueLabelStaticHostOffset) + labelTransformedOverlap - labelFontSize / 2;
                if (Math.sign(minValueLabelTranslate) === -1) {
                    minValueLabelTranslate = Math.abs(minValueLabelTranslate);
                }
                else {
