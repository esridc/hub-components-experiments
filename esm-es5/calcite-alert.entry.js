...
var CalciteAlert = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.closeAlert = function () {
            _this.queued = false;
            _this.active = false;
            _this.queue = _this.queue.filter(function (e) { return e !== _this.el; });
            _this.determineActiveAlert();
            _this.calciteAlertSync.emit({ queue: _this.queue });
            _this.calciteAlertClose.emit({
                el: _this.el,
                queue: _this.queue
            });
        };
    ...
    class_1.prototype.render = function () {
        ...
        var closeButton = (h("button", { "aria-label": this.intlClose, class: "alert-close", onClick: this.closeAlert, ref: function (el) { return (_this.closeButton = el); }, type: "button" }, h("calcite-icon", { icon: "x", scale: "m" })));
    ...
    class_1.prototype.determineActiveAlert = function () {
        ...
        if (((_a = this.queue) === null || _a === void 0 ? void 0 : _a[0]) === this.el) {
            this.openAlert();
            if (this.autoDismiss) {
                setTimeout(function () { return _this.closeAlert(); }, DURATIONS[this.autoDismissDuration]);
            }
        }
        else
            return;
