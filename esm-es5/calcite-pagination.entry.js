...
var CalcitePagination = /** @class */ (function () {
    ...
    class_1.prototype.renderPage = function (start) {
        var _a;
        var _this = this;
        var page = Math.floor(start / this.num) + (this.num === 1 ? 0 : 1);
    ...
    class_1.prototype.render = function () {
        ...
        var prevDisabled = num === 1 ? start <= num : start < num;
        var nextDisabled = num === 1 ? start + num > total : start + num > total;
        return (h(Host, { dir: dir }, h("button", { "aria-label": this.textLabelPrevious, class: (_a = {},
                _a[CSS.previous] = true,
                _a[CSS.disabled] = prevDisabled,
                _a), disabled: prevDisabled, onClick: this.previousClicked }, h("calcite-icon", { dir: dir, flipRtl: true, icon: "chevronLeft", scale: iconScale })), total > num ? this.renderPage(1) : null, this.renderLeftEllipsis(iconScale), this.renderPages(), this.renderRightEllipsis(iconScale), this.renderPage(this.getLastStart()), h("button", { "aria-label": this.textLabelNext, class: (_b = {},
                _b[CSS.next] = true,
                _b[CSS.disabled] = nextDisabled,
                _b), disabled: nextDisabled, onClick: this.nextClicked }, h("calcite-icon", { dir: dir, flipRtl: true, icon: "chevronRight", scale: iconScale }))));
    };
