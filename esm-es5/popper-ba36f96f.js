...
function createPopper$1(_a) {
    var referenceEl = _a.referenceEl, el = _a.el, placement = _a.placement, modifiers = _a.modifiers;
    if (!referenceEl) {
        return null;
    }
...
function updatePopper(_a) {
    var el = _a.el, modifiers = _a.modifiers, PopperPlacement = _a.placement, popper = _a.popper;
    var placement = getPlacement(el, PopperPlacement);
    popper.setOptions({
        modifiers: modifiers,
        placement: placement
    });
...
var defaultOffsetDistance = Math.ceil(hypotenuse(visiblePointerSize, visiblePointerSize));
