...
var CalciteStepper = /** @class */ (function () {
    ...
    //
    //--------------------------------------------------------------------------
    class_1.prototype.addHorizontalContentContainer = function () {
    ...
    class_1.prototype.focusPrevItem = function (e) {
        var index = this.itemIndex(e);
        var prevItem = this.sortedItems[index - 1] || this.sortedItems[this.sortedItems.length - 1];
        ...
        if (!isIE) {
            ...
            content.forEach(function (contentItem) {
                if (contentItem.nodeName === "#text") {
                    var text = document.createTextNode(contentItem.textContent.trim());
                    if (text.length > 0)
                        _this.stepperContentContainer.appendChild(text);
                }
                else if (contentItem.nodeName) {
                    _this.stepperContentContainer.insertAdjacentHTML("beforeend", contentItem.outerHTML);
                }
                else
                    return;
            });
...
var CalciteStepperItem = /** @class */ (function () {
    ...
    //
    //--------------------------------------------------------------------------
    CalciteStepperItem.prototype.renderIcon = function () {
