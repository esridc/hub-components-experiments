...
import { s as setRequestedIcon, g as getElementDir } from './dom-29efd1ef.js';
import { u as updateContent } from './hub-content-82335dfd.js';
import './index-fd5669bb.js';
import { g as getItem } from './index-2b41d503.js';
...
var CalciteNotice = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        var closeButton = (h("button", { "aria-label": this.intlClose, class: "notice-close", onClick: function () { return _this.close(); }, ref: function () { return _this.closeButton; } }, h("calcite-icon", { icon: "x", scale: "m" })));
...
var hubMetadataEditorCss = ":host{display:block}";
var HubMetadataEditor = /** @class */ (function () {
    function HubMetadataEditor(hostRef) {
        registerInstance(this, hostRef);
    ...
    HubMetadataEditor.prototype.componentWillLoad = function () {
        var _this = this;
        this.session = readSessionFromCookie();
        this.getItem(this.item).then(function (response) {
            console.log("HubMetadata componentDidLoad", response);
            _this.resource = response; // For sending into the metadata form
            _this.itemTitle = response.title;
            _this.tags = response.tags;
            _this.summary = response.snippet;
        });
    };
    HubMetadataEditor.prototype.getItem = function (itemId) {
        console.log("HubMetadata getItem", [itemId, this.session]);
        var authentication = UserSession.deserialize(this.session);
        return getItem(itemId, { authentication: authentication });
        // return Portal.getItem(itemId)
    };
    HubMetadataEditor.prototype.saveForm = function (e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    HubMetadataEditor.prototype.render = function () {
        var _this = this;
        return (h(Host, null, h("metadata-form", { sections: ["content-simple"], resource: this.resource }), h("calcite-button", { onClick: function (event) { return _this.saveForm(event); } }, "Save Info")));
    };
    return HubMetadataEditor;
}());
HubMetadataEditor.style = hubMetadataEditorCss;
export { CalciteNotice as calcite_notice, HubMetadataEditor as hub_metadata_editor };
