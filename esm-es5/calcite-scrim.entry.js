...
var CalciteScrim = /** @class */ (function () {
    ...
    CalciteScrim.prototype.render = function () {
        var loaderNode = this.loading ? h("calcite-loader", { active: true, label: this.intlLoading }) : null;
