...
import { d as debounce, f as forIn } from './lodash-4311644d.js';
var CSS = {
...
var CalciteFilter = /** @class */ (function () {
    ...
    CalciteFilter.prototype.render = function () {
        var _this = this;
        var rtl = getElementDir(this.el) === "rtl";
        return (h(Host, null, h("label", { class: rtl ? CSS_UTILITY.rtl : null }, h("input", { "aria-label": this.intlLabel || TEXT.filterLabel, onInput: this.inputHandler, placeholder: this.placeholder, ref: function (el) {
                _this.textInput = el;
