...
var CalciteTile = /** @class */ (function () {
    ...
    //
    // --------------------------------------------------------------------------
    CalciteTile.prototype.renderTile = function () {
        var isLargeVisual = this.heading && this.icon && !this.description;
        var iconStyle = isLargeVisual
            ? {
                height: "64px",
                width: "64px"
            }
    ...
    CalciteTile.prototype.render = function () {
