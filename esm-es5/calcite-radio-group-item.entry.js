...
var CalciteRadioGroupItem = /** @class */ (function () {
    ...
    CalciteRadioGroupItem.prototype.render = function () {
        ...
        var appearance = getElementProp(this.el, "appearance", "solid");
        var layout = getElementProp(this.el, "layout", "horizontal");
        var iconEl = (h("calcite-icon", { class: "radio-group-item-icon", dir: dir, flipRtl: this.iconFlipRtl, icon: this.icon, scale: "s" }));
