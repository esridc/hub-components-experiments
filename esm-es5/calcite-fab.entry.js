...
var CalciteFab = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        var _this = this;
        var _a = this, appearance = _a.appearance, color = _a.color, disabled = _a.disabled, el = _a.el, loading = _a.loading, scale = _a.scale, theme = _a.theme, textEnabled = _a.textEnabled, icon = _a.icon, label = _a.label, text = _a.text;
        var titleText = !textEnabled && text;
        var title = label || titleText;
        var dir = getElementDir(el);
        return (h(Host, null, h("calcite-button", { appearance: appearance, "aria-label": label, class: CSS.button, color: color, dir: dir, disabled: disabled, iconStart: icon, loading: loading, ref: function (buttonEl) {
