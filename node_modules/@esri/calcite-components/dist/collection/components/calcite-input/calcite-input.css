...
.calcite--rtl .number-button-item.number-button-item--horizontal[data-adjustment=down] {
  border-width: 1px;
  border-left-width: 0;
  border-color: var(--calcite-ui-border-input);
}

.calcite--rtl .number-button-item.number-button-item--horizontal[data-adjustment=up] {
  border-width: 1px;
  border-right-width: 0;
  border-color: var(--calcite-ui-border-input);
}
...
:host([number-button-type=vertical]) .calcite--rtl .number-button-item {
  border-width: 1px;
  border-style: solid;
  border-color: var(--calcite-ui-border-input);
  border-right-width: 0;
...
.calcite--rtl .resize-icon-wrapper {
  left: 2px;
  right: unset;
}
