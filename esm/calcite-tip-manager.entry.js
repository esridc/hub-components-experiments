...
const CalciteTipManager = class {
    ...
    render() {
        ...
        return (h(Host, null, h("section", { "aria-hidden": closed.toString(), class: CSS.container, hidden: closed, onKeyUp: this.tipManagerKeyUpHandler, ref: this.storeContainerRef, tabIndex: 0 }, h("header", { class: CSS.header }, h("h2", { class: CSS.heading, key: selectedIndex }, groupTitle), h("calcite-action", { class: CSS.close, icon: ICONS.close, onClick: this.hideTipManager, text: closeLabel })), h("div", { class: {
