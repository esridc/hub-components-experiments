...
const HubMetadataEditor = class {
    ...
    render() {
        return (h(Host, null, h("metadata-form", { sections: ["content-simple"], resource: this.resource }), h("calcite-button", { onClick: (event) => this.saveForm(event) }, "Save Info")));
    }
};
