...
import { T as TEXT, g as getLocaleData } from './resources-f8ab0ce6.js';
import { g as getElementDir } from './dom-b47352c7.js';
import { d as dateToISO, a as dateFromISO, b as dateFromRange, s as sameDate, p as parseDateString, i as inRange } from './date-19707353.js';
...
import { u as updatePopper, C as CSS, c as createPopper } from './popper-c6482c76.js';
import './locale-80df5afc.js';
...
let CalciteInputDatePicker = class {
  ...
  render() {
    ...
    return (h(Host, { onBlur: this.deactivate, onKeyUp: this.keyUpHandler, role: "application" }, this.localeData && (h("div", { "aria-expanded": this.active.toString(), class: "input-container", dir: dir, role: "application" }, h("div", { class: "input-wrapper", ref: this.setStartWrapper }, h("calcite-input", { class: `input ${this.layout === "vertical" && this.range ? `no-bottom-border` : ``}`, disabled: disabled, icon: "calendar", label: getLabelText(this), "number-button-type": "none", onCalciteInputBlur: this.inputBlur, onCalciteInputFocus: this.startInputFocus, onCalciteInputInput: this.inputInput, placeholder: (_a = this.localeData) === null || _a === void 0 ? void 0 : _a.placeholder, ref: this.setStartInput, scale: this.scale, type: "text", value: formattedDate })), h("div", { "aria-hidden": (!this.active).toString(), class: "menu-container", ref: this.setMenuEl }, h("div", { class: {
