...
let HubChat = class {
  ...
  render() {
    return (h(Host, null, h("div", { id: "body" }, h("div", { id: "chat-circle", class: "btn btn-raised", onClick: () => this.toggleChatbox(), ref: (el) => this.chatCircleEl = el }, h("div", { id: "chat-overlay" }), h("svg", { width: "32", height: "32" }, h("path", { d: speechBubbles32 }))), h("div", { class: "chat-box", ref: (el) => this.chatBoxEl = el }, h("div", { class: "chat-box-header" }, this.name, h("span", { class: "chat-box-toggle", onClick: () => this.toggleChatbox() }, h("svg", { width: "32", height: "32" }, h("path", { d: x32 })))), h("div", { class: "chat-box-body" }, h("div", { class: "chat-box-overlay" }), h("div", { class: "chat-logs" }, this.messages.map((message) => 
    //  add cm-msg- prefix below
    h("div", { id: "cm-msg-" + this.messageCount, class: `cm-msg-${message.type} chat-msg ${message.user ? message.user : 'user2'}` }, h("span", { class: "msg-avatar" }, h("img", { src: `https://i.pravatar.cc/150?u=${message.user ? message.user : 'user2'}@sonar` })), h("div", { innerHTML: message.text, class: `cm-msg-body cm-msg-${message.type}`, onClick: () => this.sendAction(message) }))))), h("div", { class: "chat-input" }, h("form", { onSubmit: (e) => this.submitChat(e) }, h("input", { type: "text", id: "chat-input", placeholder: this.placeholder, value: this.chatInput, onInput: e => this.onInput(e), ref: (el) => this.chatInputEl = el }), h("button", { type: "submit", class: "chat-submit", id: "chat-submit" }, h("svg", { width: "32", height: "32" }, h("path", { d: send24 })))))))));
  }
